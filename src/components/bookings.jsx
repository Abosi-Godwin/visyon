      ...
      <div className="max-w-7xl mx-auto px-4 w-full relative z-10 py-16 lg:py-0">
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="bg-white/90 backdrop-blur-sm lg:bg-transparent p-8 lg:p-0 rounded-sm">
            <span className="text-visyon-gold font-bold text-xs tracking-widest uppercase">Book Appointment</span>
            <h2 className="text-4xl md:text-5xl font-serif text-visyon-dark mt-2 mb-6">Plan Your Visit Now</h2>
            <p className="text-visyon-gray mb-8 max-w-md leading-relaxed">
              Suspendisse sed suscipit quam. Phasellus turpis nulla, tempus nec dignissim sed, 
              interdum a turpis. Phasellus id dolor ultricies, facilisis nulla ultrices.
            </p>
          ...
          <div className="mt-12 lg:mt-0 lg:ml-auto w-full max-w-md bg-white shadow-2xl overflow-hidden">
            <div className="p-8 lg:p-12">
              <div className="flex items-center space-x-3 mb-8">
                <span className="text-2xl text-visyon-gold"><FaClock /></span>
                <h3 className="text-2xl font-serif text-visyon-dark">Opening Hours</h3>
              </div>
              ...
              <div className="space-y-4">
                {hours.map((item, idx) => (
                  <div key={idx} className="flex justify-between items-center border-b border-gray-100 pb-4 last:border-0">
                    ...
                    <span className={`text-sm ${item.closed ? 'text-red-500 font-bold' : 'text-visyon-gray'}`}>
                      {item.time}
                    </span>
                  </div>
                ))}
