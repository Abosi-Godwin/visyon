    ...
    const reviews = [
        {
            ...
            stars: 5,
            avatar: userImgs[0],
            text: "Nunc sed augue erat. Etiam sit amet quam blandit nunc tellus, a imperdiet diam bibendum in."
        },
        {
            name: "Randy Wong",
            role: "Doctor",
            stars: 5,
            avatar: userImgs[1],
            text: "Suspendisse in neque auctor, eleifend nulla a, posuere risus. Morbi euismod purus ante."
        },
        {
            name: "Raymond Marge",
            role: "Veteran",
            stars: 5,
            avatar: userImgs[2],
            text: "Proin ac dolor eget nisl auctor volutpat. Donec a ullamcorper ligula. Sed blandit nunc tellus."
        }
    ];
