      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="relative h-[400px] md:h-[500px]">
          ...
          <div className="absolute top-0 left-0 w-4/5 h-[80%] overflow-hidden rounded-sm shadow-xl">
            <img src="/doctor-main.jpg" alt="Optometrist" className="w-full h-full object-cover" />
          </div>
          ...
          <div className="absolute bottom-0 right-0 w-1/2 h-1/2 border-8 border-white rounded-sm shadow-2xl overflow-hidden">
            <img src="/glasses-hand.jpg" alt="Holding Glasses" className="w-full h-full object-cover" />
          </div>
        </div>

        {/* Right Side: Content */}
        <div className="space-y-6">
          <span className="text-visyon-gold font-bold text-sm tracking-widest uppercase">About Us</span>
          ...
          <p className="text-visyon-gray leading-relaxed">
            Etiam interdum consequat risus, a pellentesque quam eleifend finibus. 
            Nunc sed mi metus. Maecenas consequat, tortor et eleifend iaculis, 
            nisi orci interdum libero.
          </p>
